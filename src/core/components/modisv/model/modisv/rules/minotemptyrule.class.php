 ...
 */
/**
 * The field being validated must not be empty.
 *
 * @package modisv
 */
require_once MODX_CORE_PATH . 'xpdo/validation/xpdovalidator.class.php';

class miNotEmptyRule extends xPDOValidationRule {

    public function __construct(& $validator, $field, $name) {
        parent::__construct($validator, $field, $name, 'The field \'' . $field . '\' should not be empty.');
    }
